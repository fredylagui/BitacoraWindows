...
class ModConfigView():
    ...
    def cargar_imagenes(self):
        ...
        if self.sistemaop == "linux2":
            ...
            imagenconfig_interface = "C:/Program Files/Bitacora/src/images/root-04.png"
    ...
    def surface(self):
        ...
        #self.screen.blit(self.basistencia_habilitar, self.basistencia_habilitar.get_rect(center=(170, 103)))
        #self.screen.blit(self.basistencia_deshabilitar, self.basistencia_deshabilitar.get_rect(center=(308, 103)))
        #self.screen.blit(self.bregresar, self.bregresar.get_rect(center=(235, 190)))
